...
class AuthManager:
    ...
    def start_live_mode(
        ...
        if not base_url:
            raise RuntimeError("서버 URL이 선택되지 않았습니다. 실전 또는 모의 서버를 선택해주세요.")

        account_no = _normalize_account(account_no)
